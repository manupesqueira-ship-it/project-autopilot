...
| ~~10~~ | ~~**Stack del control plane: Python directo vs framework**~~ | ~~`multi-agent-frameworks`: LangGraph como recomendación a mediano plazo (Camino A); single-agent + tools como punto de partida (Camino C).~~ | ~~MASTER_PLAN §4.2: "LLM principal: Claude (Anthropic API directa) para v1. Más simple y controlable que SDKs intermedios."~~ | **SUPERSEDED 2026-05-11** — MASTER_PLAN.md fue decompuesto el 2026-05-10; la dirección elegida es n8n cloud + Anthropic node nativo + HTTP Request para casos avanzados (prompt caching, Batch API). Ya implementado en `docs/STACK.md`, `docs/SYSTEM_DESIGN.md`, `docs/AGENTS_SPEC.md`. Research n8n templates (`2026-05-11_n8n-templates-research.md`) confirmó viabilidad. |
