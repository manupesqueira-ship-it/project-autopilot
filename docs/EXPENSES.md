...
- 2026-07-02 · Workflows Anthropic (ultracode) · 2 mesas multi-agente (arquitectura 7 agentes + auditoría 50 agentes) para el plan maestro `docs/SISTEMA_DINERO_IA.md` · ~3.9M tokens subagente (uso de API Claude de la sesión, no cargo separado). Diagnóstico + arquitectura de agentes + reglas + roadmap P0-P2