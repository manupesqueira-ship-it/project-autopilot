...
def plan_task(project: ProjectConfig, task: str) -> BuilderPlan:
    ...
    if is_claude_sandbox:
        ...
        validations.append(f"python -B project_autopilot/agent_loop.py --project {project.project_id} --claude-manual-handoff-dry-run --task \"{task}\"")
        ...
        notes.append("Manual Claude handoff may be generated only after sandbox preflight, approval, worktree creation, and prompt pack evidence exist.")
